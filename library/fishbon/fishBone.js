$.fn.fishBone = function (data) {
    ...
    function creataFishBone(data) {
        ...
        $(data).each(function (index) {
            ...
            if (itemclass == 'top') {
                if (tmpdata['time']) {
                    var li = $("<li class='line-first'>" + tmpdata['time'] + "</li>")
                ...
                if (tmpdata['title']) {
                    ...
                    var titleCenter = $("<span class='title-center'>" + tmpdata['title'] + "</span>").css('background-position-y', titleCenterY);
